...
## Project Structure
    ...
    ├── testapiautosetting_126983  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126983`
...
2. Clone this repo and `cd testapiautosetting_126983`
